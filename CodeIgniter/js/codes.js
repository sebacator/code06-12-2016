...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
          ...
          bootbox.dialog({
            ...
            '<div class="form-group">' +
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="agregar_alumno" class="form-control" placeholder="Cantidad de alumnos" required>' +
              '</div>' +
            '</div>',
            buttons: {
              cancel: {
              ...
              ok: {
                ...
                callback: function(e) {
                  ...
                  tabla.row.add({
                    ...
                    "num_alumnos": $('#agregar_alumno').val()
                  }).draw();
    ...
    columns: [
      ...
      {data: 'num_alumnos', title: 'Alumnos'},
      {
  ...
  function btnEditarEvent() {
    ...
    num_alumnos = asignatura.num_alumnos
    ;
      ...
      '<div class="form-group">' +
        '<div class="input-group">' +
          '<span class="input-group-addon">' +
            '<i class="glyphicon glyphicon-plus"></i>' +
          '</span>' +
          '<input type="text" id="editar_alumnos" class="form-control" value="' + num_alumnos + '" placeholder="Cantidad de alumnos">' +
        '</div>' +
      '</div>',
      buttons: {
        cancel: {
          ...
          callback: function(e) {
            ...
            $.ajax({
              ...
              data: {
                ...
                num_alumnos: $('#editar_alumnos').val()
              }
            })
            .fail(function(err) {
